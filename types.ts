...
export const DEFAULT_STORY_PAGES = 10;
export const LENGTH_OPTIONS = [3, 5, 10];
export const MURAL_MODE_VALUE = -1; // Special flag for Mural mode
...
export const GENRES = [
    "Superhero Action", 
    "USS Enterprise Bridge (Star Trek)",
    "Classic Horror", 
    "Dark Sci-Fi", 
    "High Fantasy", 
    "Neon Noir Detective", 
...
export interface ComicFace {
  id: string;
  type: 'cover' | 'story' | 'back_cover' | 'mural';
  imageUrl?: string;
  narrative?: Beat;
  choices: string[];
